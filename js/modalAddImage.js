...
// This file handles uploading locally simulated works.
...
async function handleImageSubmit(e, inputFile, inputTitle, selectCategory, divCaseAdd, addImgContainer) {
    ...
    // read file as data url so we can persist it in localStorage
    ...
    try {
        const newProject = await api.addWork({
        ...
        showAddImageError("Impossible d'ajouter le projet (erreur réseau ou autorisation). Vous pouvez réessayer.");
    }
}
